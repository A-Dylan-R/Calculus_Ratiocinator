...
public class Main {
    public static void main(String[] args) {
        ...
        Affirmation résultat5 = calculateur.évaluerOu(mensonge_1, affirmation_1);
        ...
        System.out.println(résultat5.getTexte() + " : " + (résultat5.getValeur() != null ? résultat5.getValeur() : "jenesaispas"));
    }
}
